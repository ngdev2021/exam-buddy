...
import { HomeIcon, ClipboardIcon, PencilIcon, UserCircleIcon, CalculatorIcon, MicrophoneIcon, AcademicCapIcon } from "@heroicons/react/24/outline";
...
export const navigationItems = [
  ...
  { path: "/tutor", label: "Tutor", icon: <AcademicCapIcon className="w-6 h-6" /> },
